...
<div class="main-content">
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3><span>Pending CNG Pumps</span></h3>
                </div>
                <div class="card-body">
                    <form  >
  ...
  try
  {
	  ...
	  PreparedStatement ps2 = con.prepareStatement("select * from cngpumps_tbl where position=?");
	  ps2.setString(1, pos);
  ...
  %>
    <tr>
      ...
      <td><a href="Approve.jsp?id=<%= rs.getString(1)%>">Approve</a></td>
