    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
       <li><a href="index.html"><i class="fa fa-tachometer"></i><span>Home Screen</span></a>
        ...
        <li class="">
          <a href="cngpumpslogin.html"><i class="fa fa-table"></i> <span>Login</span></a>
         
        </li>
        <li class="">
          <a href="cngpumpregi.html"><i class="fa fa-table"></i> <span>New Register</span></a>
         
        </li>
        <li><a href="ViewAllcngPumps.jsp"><i class="fa fa-table"></i> <span>View CNG Pumps </span></a></li>
    ...
    <div class="container-fluid content-top-gap">
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                    <form action="ViewAllcngPumps.jsp" >
                     <%
