    ...
    <div class="sidebar-menu-inner">
     ...
     <ul class="nav nav-pills nav-stacked custom-nav">
       <li><a href="index.html"><i class="fa fa-tachometer"></i><span>Home Screen</span></a>
        ...
        <li class="">
          <a href="updatedata.html"><i class="fa fa-table"></i> <span>Update Data</span></a>
         
        </li>
        <li class="">
          <a href="viewbooking.jsp"><i class="fa fa-table"></i> <span>View Booking</span></a>
         
        </li>
        <li><a href="cngpumpsrelated.html"><i class="fa fa-th"></i> <span>Logout</span></a></li>
...
<div class="main-content">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Order Quantity(in KG's)</th>
    </tr>
  </thead>
  <tbody>
  <%
  try
  {
		...
		PreparedStatement ps2 = con.prepareStatement("select * from viewbooking_tbl where pump_id=?");
		ps2.setInt(1, Usersource.getPumpid());
